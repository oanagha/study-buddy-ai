...
function Login() {
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-slate-100 p-4 sm:p-8">
      <div className="w-full max-w-5xl bg-white rounded-3xl shadow-2xl overflow-hidden grid md:grid-cols-2 min-h-[600px]">
        {/* Left blue panel */}
        ...
        <div className="p-10 sm:p-12 flex flex-col justify-center">
          ...
          >
            ...
            <label className="flex items-center gap-2 text-xs text-slate-600 pt-1">
              <input type="checkbox" className="h-3.5 w-3.5 accent-[#2563eb]" />
              <span>Keep me signed in.{" "}
                <a href="#" className="text-[#2563eb] hover:underline">Forgot password?</a>
              </span>
            </label>
